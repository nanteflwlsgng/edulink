...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/studentDashboard", // 4. La route protégée (accessible via logique dans le composant)
        element: <Dashboard/>,
      },
      {
        path: "/schoolDashboard", // 4. La route protégée (accessible via logique dans le composant)
