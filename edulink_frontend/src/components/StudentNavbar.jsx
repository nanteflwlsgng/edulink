...
export default function StudentNavbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white backdrop-blur-md z-[90] font-poppins transition-all duration-300">
        ...
        <div className="hidden md:flex items-center gap-6">
            <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#18B49C] to-[#27b6d8] flex items-center justify-center text-white font-bold shadow-lg shadow-[#18B49C]/20">
                  {(user?.prenom || studentProfile?.utilisateur?.prenom || "U").charAt(0).toUpperCase()}                </div>
            </div>
