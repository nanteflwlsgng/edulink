  ...
  const handleNextOrSubmit = async (e) => {
    ...
    if (step === 1) {
      ...
      if (!formData.password || formData.password !== formData.confirmPassword) {
       ...
       const dataToSend = {
          prenom: formData.firstName,     // firstName devient prenom
          nom: formData.lastName,         // lastName devient nom
          email: formData.email,          // email reste email
          mot_de_passe: formData.password,  // password devient motDePasse (C'est ça qui corrige l'erreur !)
          telephone: formData.phone,      // phone devient telephone
